...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		int sumNum = ((getNumerator() * that.getDenominator()) + (that.getNumerator() * getDenominator()));
		int sumDenom = getDenominator() * that.getDenominator();
		
		return construct(sumNum, sumDenom);
	}
	...
	default IRational sub(IRational that) throws IllegalArgumentException {
		...
		int subNum = ((getNumerator() * that.getDenominator()) - (that.getNumerator() * getDenominator()));
		int subDenom = getDenominator() * that.getDenominator();
		
		return construct(subNum, subDenom);
	}
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		...
		int prodNum = getNumerator() * that.getNumerator();
		int prodDenom = getDenominator() * that.getDenominator();
		
		return construct(prodNum, prodDenom);
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		...
		int divNum = getNumerator() * that.getDenominator();
		int divDenom = getDenominator() * that.getNumerator();
		
		return construct(divNum, divDenom);
	}
}
